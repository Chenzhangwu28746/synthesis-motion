...
import pytorch_ssim
from removed.version4.data_utils import TrainDatasetFromFolder, ValDatasetFromFolder, display_transform
from loss import GeneratorLoss
from removed.version4.model import Generator, Discriminator
...
train_set = TrainDatasetFromFolder('data/VOC2012/celeba', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
val_set = ValDatasetFromFolder('data/VOC2012/val', upscale_factor=UPSCALE_FACTOR)
train_loader = DataLoader(dataset=train_set, num_workers=4, batch_size=400, shuffle=True)

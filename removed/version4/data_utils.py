...
def get_statistics(data):
    ...
    ## 对 骨架 和每个关节分别统计，因为每个关节的活动范围各有不同
...
if __name__ == "__main__":
    #data = load_all_bvh_from_dirctory('./v5/walk_id_compacted')  #shape: (161,2) 161X([241,96],1)
    ...
    #load_bvh_from_file('./v5/walk_id_compacted/00_01_1.bvh')
    print("hello")
    print("hello")
